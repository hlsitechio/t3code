...
function SidebarRail({
  ...
  return (
    <button
      ...
      className={cn(
        "-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0 z-30 hidden w-5 bg-transparent transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-px after:-translate-x-1/2 after:bg-sidebar-border/70 hover:after:bg-primary/70 group-data-[side=right]:left-0 sm:flex",
